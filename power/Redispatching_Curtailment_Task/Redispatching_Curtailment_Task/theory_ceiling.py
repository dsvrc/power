...
# Rebound by --n-zones. The decomposition is a property of the PARTITION as
# much as of the grid: which line is a tie-line, and therefore which damage is
# peer-recoverable, is decided here.
...
def main():
    ...
    ap.add_argument("--n-zones", type=int, default=None,
                    help="decompose on the N-zone partition generated by "
                         "make_zones.py (default: the shipped 11)")
    args = ap.parse_args()
